 ...
 * @author Yuri Shmakov
 */
public final class GithubApp extends Application {
	...
	public void onCreate() {
		...
		GithubApp.sAppComponent = DaggerAppComponent.builder()
